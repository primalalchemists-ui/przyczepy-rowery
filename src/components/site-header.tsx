    ...
    <header className="border-b bg-background/80 backdrop-blur" style={{ ['--header-h' as any]: '72px' }}>
      <nav className="mx-auto flex w-full max-w-[1400px] items-center justify-between gap-4 px-4 py-3">
        ...
        >
          ...
          <span className="text-base font-semibold tracking-tight hover:text-primary">
            {siteName}
          </span>
        </Link>
                  ...
                  return (
                    <SheetClose asChild key={item.href}>
                      <Button
                        ...
                        className={
                          highlighted
                            ? 'h-12 justify-start px-4 text-base bg-accent text-accent-foreground hover:opacity-80 transition'
                            : 'h-12 justify-start px-4 text-base hover:bg-accent transition'
                        }
