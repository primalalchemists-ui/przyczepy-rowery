...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_rezerwacje_status" AS ENUM('draft', 'pending_payment', 'paid', 'confirmed', 'cancelled', 'blocked');
  ...
  CREATE TABLE "przyczepy" (
  	...
  	"slug" varchar NOT NULL,
  	"active" boolean DEFAULT true NOT NULL,
  	"opis_krotki" varchar NOT NULL,
  	"opis_dlugi" jsonb NOT NULL,
  ...
  CREATE TABLE "rezerwacje" (
  	...
  	"status" "enum_rezerwacje_status" DEFAULT 'draft' NOT NULL,
  	"klient_full_name" varchar,
  	"klient_email" varchar,
  	"klient_phone" varchar,
  	"klient_nip" varchar,
  ...
  CREATE TABLE "ustawienia_rezerwacji" (
  	...
  	"terms_pdf_id" integer,
  	"regulations_pdf_id" integer,
  ...
  ALTER TABLE "ustawienia_rezerwacji" ADD CONSTRAINT "ustawienia_rezerwacji_terms_pdf_id_media_id_fk" FOREIGN KEY ("terms_pdf_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "ustawienia_rezerwacji" ADD CONSTRAINT "ustawienia_rezerwacji_regulations_pdf_id_media_id_fk" FOREIGN KEY ("regulations_pdf_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "ustawienia_rezerwacji_terms_pdf_idx" ON "ustawienia_rezerwacji" USING btree ("terms_pdf_id");
  CREATE INDEX "ustawienia_rezerwacji_regulations_pdf_idx" ON "ustawienia_rezerwacji" USING btree ("regulations_pdf_id");`)
}
